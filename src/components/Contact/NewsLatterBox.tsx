...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      Fique por dentro das últimas novidades e tendências em tecnologia, marketing digital, e-commerce e muito mais.
       Inscreva-se em nossa newsletter para receber atualizações regulares diretamente em sua caixa de entrada. 
       Não perca a oportunidade de estar sempre um passo à frente no mundo digital.
        Junte-se a nós e faça parte da comunidade Gam Consultoria.
      </p>
      <div>
        <input
          type="text"
